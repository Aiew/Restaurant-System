          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo site_url('dashboard/employeeAdd'); ?>"><i class="fa fa-circle-o"></i> เพิ่มพนักงาน</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li ><a href="<?php echo site_url('dashboard/food_list'); ?>"><i class="fa fa-table"></i> <span>รายการอาหาร</span></a></li>
            <li ><a href="<?php echo site_url('dashboard/serve_list'); ?>"><i class="fa fa-table"></i> <span>อาหารที่สั่ง</span></a></li>
            <li ><a href="<?php echo site_url('dashboard/table'); ?>"><i class="fa fa-table"></i> <span>โต๊ะ</span></a></li>
            <li ><a href="<?php echo site_url('dashboard/receipt_list'); ?>"><i class="fa fa-table"></i> <span>ใบเสร็จค่าอาหาร</span></a></li>
