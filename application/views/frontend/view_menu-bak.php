        ...
        <div class="tabs-menu tabs-page">
            <div class="container">
                <ul class="nav-tabs text-center" role="tablist">
                    ...
                    <li><a href="#drink" role="tab" data-toggle="tab">Drink</a></li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="tab-pane fade in active" id="breakfast">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="the-menu-item">
                                    <div class="image-wrap">
                                        <img src="<?php echo base_url('public')?>/images/themenu/img-1.jpg" alt="">
                                    </div>
                                    <div class="the-menu-body">
                                        <h4 class="xsm">Scrambled Eggs in Puff Scrambled Eggs in Puff Pastry</h4>
                                        <p>with “soldiers”</p>
                                    </div>
                                    <div class="prices">
                            ...
                            <div class="col-lg-6">
                                <div class="the-menu-item">
                                    <div class="image-wrap">
                                        <img src="<?php echo base_url('public')?>/images/themenu/img-2.jpg" alt="">
                                    </div>
                                    <div class="the-menu-body">
                                        <h4 class="xsm">Scrambled Eggs in Puff Pastry</h4>
                                        <p>with “soldiers”</p>
                                    </div>
                                    <div class="prices">
                                        <span class="price xsm">$16.00</span>
                            ...
                            <div class="col-lg-6">
                                <div class="the-menu-item">
                                    <div class="image-wrap">
                                        <img src="<?php echo base_url('public')?>/images/themenu/img-3.jpg" alt="">
                                    </div>
                                    <div class="the-menu-body">
                                        <h4 class="xsm">Scrambled Eggs in Puff Pastry</h4>
                                        <p>with “soldiers”</p>
                            ...
                            <div class="col-lg-6">
                                <div class="the-menu-item">
                                    <div class="image-wrap">
                                        <img src="<?php echo base_url('public')?>/images/themenu/img-4.jpg" alt="">
                                    </div>
                                    <div class="the-menu-body">
                                        <h4 class="xsm">Scrambled Eggs in Puff Pastry</h4>
                                        <p>with “soldiers”</p>
                            ...
                            <div class="col-lg-6">
                                <div class="the-menu-item">
                                    <div class="image-wrap">
                                        <img src="<?php echo base_url('public')?>/images/themenu/img-5.jpg" alt="">
                                    </div>
                                    <div class="the-menu-body">
                                        <h4 class="xsm">Scrambled Eggs in Puff Pastry</h4>
                                        <p>with “soldiers”</p>
